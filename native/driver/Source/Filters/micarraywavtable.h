...
#ifndef _MIXBRIDGE_MICARRAYWAVTABLE_H_
#define _MIXBRIDGE_MICARRAYWAVTABLE_H_
...
static
MIXBRIDGE_PROPERTY_ITEM PropertiesMicArrayWaveFilter[] =
{
    {
        {
            &KSPROPSETID_General,
...
#endif // _MIXBRIDGE_MICARRAYWAVTABLE_H_
