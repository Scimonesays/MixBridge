...
#ifndef _MIXBRIDGE_MICARRAYTOPO_H_
#define _MIXBRIDGE_MICARRAYTOPO_H_
...
class CMicArrayMiniportTopology :
    public CMiniportTopologyMixBridge,
...
public:
    ...
    (
        ...
        CMiniportTopologyMixBridge(FilterDesc, DeviceMaxChannels),
...
#endif // _MIXBRIDGE_MICARRAYTOPO_H_
