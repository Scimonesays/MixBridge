...
#ifndef _MIXBRIDGE_COMMON_H_
#define _MIXBRIDGE_COMMON_H_
...
//
//=============================================================================
typedef struct _MIXBRIDGE_DEVPROPERTY {
    const DEVPROPKEY   *PropertyKey;
    DEVPROPTYPE Type;
    ULONG BufferSize;
    __field_bcount_opt(BufferSize) PVOID Buffer;
} MIXBRIDGE_DEVPROPERTY, PMIXBRIDGE_DEVPROPERTY;
...
typedef struct _ENDPOINT_MINIPAIR 
{
    ...
    // Topology miniport.
    PWSTR                           TopoName;               // make sure this or the template name matches with MIXBRIDGE.<TopoName>.szPname in the inf's [Strings] section
    ...
    const MIXBRIDGE_DEVPROPERTY*       TopoInterfaceProperties;

    // Wave RT miniport.
    PWSTR                           WaveName;               // make sure this or the template name matches with MIXBRIDGE.<WaveName>.szPname in the inf's [Strings] section
    ...
    const MIXBRIDGE_DEVPROPERTY*       WaveInterfaceProperties;
