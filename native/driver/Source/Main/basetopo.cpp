...
CMiniportTopologyMixBridge::CMiniportTopologyMixBridge
(
...
#pragma code_seg("PAGE")
NTSTATUS
CMiniportTopologyMixBridge::DataRangeIntersection
( 
    _In_  ULONG                 PinId,
...
#pragma code_seg("PAGE")
NTSTATUS
CMiniportTopologyMixBridge::GetDescription
( 
...
#pragma code_seg("PAGE")
NTSTATUS
CMiniportTopologyMixBridge::Init
( 
...
--*/
{
    ...
    DPF_ENTER(("[CMiniportTopologyMixBridge::Init]"));
...
#pragma code_seg("PAGE")
NTSTATUS                            
CMiniportTopologyMixBridge::PropertyHandlerGeneric
(
...
#pragma code_seg("PAGE")
NTSTATUS                            
CMiniportTopologyMixBridge::PropertyHandlerMuxSource
(
    _In_  PPCPROPERTY_REQUEST     PropertyRequest
)
/*++
...
#pragma code_seg("PAGE")
NTSTATUS                            
CMiniportTopologyMixBridge::PropertyHandlerDevSpecific(
    _In_  PPCPROPERTY_REQUEST     PropertyRequest
)
/*++
...
#pragma code_seg("PAGE")
VOID
CMiniportTopologyMixBridge::AddEventToEventList
(
...
#pragma code_seg()
VOID
CMiniportTopologyMixBridge::GenerateEventList
(
    _In_opt_    GUID   *Set,
    _In_        ULONG   EventId,
    _In_        BOOL    PinEvent,
...
--*/
{
    DPF_ENTER(("[CMiniportTopologyMixBridge::GenerateEventList]"));
