...
NTSTATUS
CreateMiniportTopologyMixBridge
( 
...
--*/
{
    ...
    return CMiniportTopologyMixBridge::GetDescription(OutFilterDescriptor);        
} // GetDescription
...
--*/
{
    ...
    IF_FAILED_ACTION_JUMP(
        ntStatus,
        DPF(D_ERROR, ("Init: CMiniportTopologyMixBridge::Init failed, 0x%x", ntStatus)),
        Done);
